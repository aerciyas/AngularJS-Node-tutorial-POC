(function(){
    ...
    var bookmarksModelModule = angular.module('eggly.models.bookmarks', [

    ]);

    bookmarksModelModule.service('BookmarksModel', function($http, $q)
        {
            var model = this,
                bookmarks,
                URLS = {
            ...
            model.justAlert = function()
            {
                alert('made an session model alert!');
            };
            ...
            model.getBookmarks = function()
            {
                ...
                else
                {
                    ...
                    {
                        return deferred.resolve(cacheBookmarks(bookmarks))
                    });
                }
